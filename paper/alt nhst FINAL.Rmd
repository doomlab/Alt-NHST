...
```{r agree-graph-omnibus, warning = FALSE, echo=FALSE, fig.cap="Percent of agreement across all analyses given effect size and sample size for omnibus tests.", fig.height=8, fig.width=8}
