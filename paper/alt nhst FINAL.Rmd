...
CHANGE EFFECT (ALPHA) TO A DIFFERENT LETTER SO AS NOT TO CONFUSE WITH CUTOFF?
$$
\begin{aligned}
...
```{r effects-pcc-p, echo = FALSE, fig.cap="WHAT DO YOU WANT THIS TO SAY", fig.height=8, fig.width=8}
...
nonepcc = ggplot(none, aes(oompcc, effect1v2, color = N)) +
  cleanup + 
  geom_point() +
...
smallpcc = ggplot(small, aes(oompcc, effect1v2, color = N)) +
  cleanup + 
  geom_point() +
  ylab("Effect Size d Value") + 
  xlab("OOM PCC Value") + 
...
medpcc = ggplot(med, aes(oompcc, effect1v2, color = N)) +
  cleanup + 
  geom_point() +
  ylab("Effect Size d Value") + 
  xlab("OOM PCC Value") + 
...
largepcc = ggplot(large, aes(oompcc, effect1v2, color = N)) +
  cleanup + 
  geom_point() +
  ylab("Effect Size d Value") + 
  xlab("OOM PCC Value") + 
...
pccgraph <- plot_grid( nonepcc + theme(legend.position="none"),
                   ...
                   largepcc + theme(legend.position=c(.8, .85)),
                   hjust = -1,
                   nrow = 2
)
pccgraph
...
pccbfmed = ggplot(comparemed, aes(oompcc, overallBF)) + 
         ...
         scale_shape_manual(name = "c-Value",
                              ...
                              values = c(16,4)) +
        scale_color_grey() +
        labs(title="Medium Effects (d=0.20)") +
        scale_x_continuous(labels = numform::ff_num(zero = 0))
