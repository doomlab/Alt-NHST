...
write.csv(Percent100agree, file = "Percent100Agree.05np.csv")
write.csv(PercentOfAgreementIsSig, file = "PercentIsSig.05np.csv")
write.csv(PercentOfAgreementIsNonSig, file = "PercentIsNonSig.05np.csv")
